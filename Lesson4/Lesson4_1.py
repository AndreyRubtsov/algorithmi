...
# Проверил 3 варианта алгоритма. в первом случае использовалась рекурсия и соответственно квадратичная зависимость, этот
# вариант был самый длительный в выполнении по timeit. В двух других использовалась линейная зависимость, соответственно
# cProfile ничего страшного не нашел, но 3 алгоритм показал результаты лучше(быстрее)